...
**EV-OAI-004** 🟡（2026-08-18 检索留痕，Batch 6）｜OpenAI 部署公司 + Tomoro｜定价信息｜**官方定价均未公开**：①启动公告与 deploy.co 均无定价条款（原文在手两处已核）；②「按结果/按任务计费」「实施费+优惠 token」等说法**全部为分析师/媒体转述**（LinkedIn/Coommit/AI Opportunities 等，L3-L4），按边界 9 不升级为官方主张；③ Tomoro（收购前）无公开定价，仅可从其 insights 文章弱推断「按项目定制」；④ 媒体补充背景（L3，未核）：19 家投资伙伴含 TPG 与 Brookfield，估值口径 100-140 亿美元不一致｜检索记录：两组关键词×3 变体，成功路径=官方公告/媒体覆盖，失败路径=官方价格页不存在｜抓取 2026-08-18｜支撑：商业模型 §1 Unknown 栏与 §8｜—｜Low（转述层）｜2026-08-18
