...
**EV-GART-001** ✅（2026-08-18 页面级核验；同日按反攻 P1 精确化）｜Gartner｜原型存活率背景｜① 官方文档《Proportion of AI and GenAI Prototypes Making It Into Production》**发布 2025-06-12**（gartner.com/en/documents/6587902）：2024 调查的平均生产转化率——**仅 41% 生成式/42% 非生成式原型进入生产**（正文需订阅，页面摘要含确切数字）——证明「原型到生产存在落差」的行业背景；② 官方新闻稿 2024-07-29（完整 URL：gartner.com/newsroom/press-releases/2024-07-29-gartner-predicts-30-percent-of-generative-ai-projects-will-be-abandoned-after-proof-of-concept-by-end-of-2025）——**预测截至 2025 年底 30% 生成式 AI 项目在 PoC 后放弃**，原因四项：数据质量差/风险控制不足/**成本上升**/业务价值不清（完整 L1，预测性质已标）｜官方｜L1（页面级）｜核验 2026-08-18｜**用途边界：支撑「原型→生产落差」背景与红队攻击素材；不直接证明「无基线不得宣 ROI」（该规则依据=内部纪律）**｜DEL-005 背景/红队｜—｜High①/High②｜2026-08-18 精确化
...
**EV-CN-002a** 🟡｜InfoQ《Demo 能跑，项目却落不了地：企业真正缺的是 FDE 能力》｜6 类高频失败模式（需求失真/价值不清/验收困难等）｜媒体课程层 L3-L4｜infoq.cn/article/ZvwSZ2U61Q8uBMerbYD9（极客时间同名课程页 b.geekbang.org/news/1ff1de774005f8da13f42943881c655f）｜**发布日期：页面未标日期**｜抓取 2026-08-18｜DOC-001 攻击背景｜—｜Low-Medium｜2026-08-18 拆分登记
**EV-CN-002b** 🟡｜至顶网《为什么中国企业 AI 落地更需要 FDE？》2026-07｜中国 toB 特殊约束：招投标/账期/信创合规｜媒体层 L3-L4｜zhiding.cn/ai-applications/2026/0728/3194636.shtml｜抓取 2026-08-18｜DOC-001/COM 背景｜—｜Low-Medium｜2026-08-18 拆分登记
**EV-CN-002c** 🟡｜网易智企《复盘 100+ AI 项目总结的真相》｜8 个跑通 ROI 场景+3 个标杆（自述）｜厂商内容 L4｜grow.163.com/cms/Z2fVVz15.html｜**发布日期：页面未标日期**｜抓取 2026-08-18｜背景素材不承担主张｜—｜Low｜2026-08-18 拆分登记（一手 FDE 失败复盘缺口保持；不以媒体集合抬级）